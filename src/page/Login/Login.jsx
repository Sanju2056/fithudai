...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen flex items-center justify-center py-6 md:py-20  md:px-10 font-sans">
      <div className="flex flex-col  md:flex-row  items-center  bg-[#f3f3f3] rounded-lg overflow-hidden border p-6 md:p-0  ">
        <div className="flex-1 w-[320px] md:p-8  flex flex-col ">
          ...
          <Link to="/home" className="w-full py-3 mb-4 flex justify-center items-center bg-purple-600 text-white rounded-lg font-semibold text-sm hover:bg-purple-700 active:scale-95 transition">
            Login
          </Link>
          ...
          <p className="text-center text-sm text-gray-400 mt-5">
            New here?{" "}
            <Link to="/signup" className="text-purple-600 font-semibold hover:underline cursor-pointer">
              Create account
            </Link>
          </p>
        </div>
